...
if __name__ == "__main__":
    ...
    svm_score_file = lbda_score_file
    ...
    for i in range(iterations):
        ...
        svm_g_input =[svm_aa,svm_gg,svm_bb]
    ...
    write_res_to_file(lbda_final_results, "LAMDAMART_abs_lbda")
    ...
    write_res_to_file(svm_final_results,"SVM_abs_lbda")
